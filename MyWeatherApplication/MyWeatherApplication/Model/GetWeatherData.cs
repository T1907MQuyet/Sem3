...
namespace MyWeatherApplication.Model
{
    public class GetWeatherData
    {
        ...
        public async static Task<RootObject> getOpenWeather()
        {
            ...
            var result = await response.Content.ReadAsStringAsync();//boc tach noi dung cua json
            //sau khi co noi dung thi biet trong no co trang thai gi 
            //thi phai import vao using System.Runtime.Serialization.Json;
            var serializer = new DataContractJsonSerializer(typeof(RootObject));
            //tao var data de luu tru ket qua thi dung memorystring
